...
<body>
    <center><h2><div class="text-primary">Registration</div></h2></center>
	<div class="container">
		<div class="row">
					...
					<div class="panel-body">
						...
						<form id="signupForm1" method="post" class="form-horizontal" action="">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="date" class="form-control" id="date" name="date" placeholder="Please Choose the Date" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-sm-5 col-sm-offset-4">
									<div class="checkbox">
										<label>
											<input type="checkbox" id="agree1" name="agree1" value="agree" />Please agree to <a href="#">Terms </a>and <a href="#">Conditions</a>
										</label>
									</div>
								</div>
							</div>
