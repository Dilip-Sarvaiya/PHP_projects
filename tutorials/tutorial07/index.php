...
th, td {
  ...
  padding: 15px;
  font-size:18px;
  background-image:url('Dilip_1.jpg');
...
<div class="container">
<h1 class="text-primary" align="center">Information Table</h1>
<a href="logout.php"><button class="btn btn-danger" id="button" valign="right">Log out</button></a>
<button class="btn btn-primary" id="button" valign="right">Add New Data</button>
